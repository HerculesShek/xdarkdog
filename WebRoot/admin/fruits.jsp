    ...
    <%
    	if(fruits != null && fruits.size()>0){
    		for(Fruit f : fruits){
    			...
    			out.println("</td>");
    			// 修改水果和删除水果的页面
    			out.println("<td><a href=\"/servlet/fruit.do?method=friutinfo&id="+f.getId()+"\">修改</a>");
    			out.println("<a href=\"/servlet/fruit.do?method=removeFruit&id="+f.getId()+"&commid="+f.getCommunityid()+"\">删除</a></td>");
    			out.print("</tr>");
    		}
    	}
    %>
    <tr>
    <td align="center" colspan="9"><a href="/admin/addfruit.jsp?commid=<%=comm.getId()%>">添加水果</a></td>
    </tr>
    </table>
